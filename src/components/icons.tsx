// Icônes SVG inline (aucune dépendance). stroke = currentColor.
...
export const IconGallery = ({ className, size }: P) => (
...
export const IconMove = ({ className, size }: P) => (
  <svg {...base(size)} className={className}>
    <path d="M4 20V6a2 2 0 0 1 2-2h3.6l2 2H18a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z" />
...
export const IconEyeOff = ({ className, size }: P) => (
  <svg {...base(size)} className={className}>
    <path d="M10.6 5.1A10.9 10.9 0 0 1 12 5c6.5 0 10 7 10 7a18 18 0 0 1-3 3.9M6.2 6.2A18 18 0 0 0 2 12s3.5 7 10 7a10.8 10.8 0 0 0 5.1-1.2" />
...
export const IconRestore = ({ className, size }: P) => (
  <svg {...base(size)} className={className}>
    <path d="M3 7v6h6" />
